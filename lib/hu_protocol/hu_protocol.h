...
#define HU_PROTOCOL_FUNCTION_RETRANSMIT 0x01
#define HU_PROTOCOL_FUNCTION_ACKNOWLEDGE 0x12
...
struct hu_protocol_SensorReadings
{ // selectie floats in een bepaalde orde
  float avgTemp;
  float avgLDR;
  float avgPot;
  float maxTemp;
